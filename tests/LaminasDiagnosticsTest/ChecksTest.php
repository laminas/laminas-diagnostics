...
class ChecksTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCpuPerformance()
    {
        ...
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $result);

        $check = new CpuPerformance(999999999); // improbable to archive
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result);
    }
    ...
    public function testClassExists()
    {
        ...
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $check->check());

        $check = new ClassExists('improbableClassNameInGlobalNamespace999999999999999999');
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $check->check());
    ...
    public function testPhpFlag()
    {
        ...
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result = $check->check());
    ...
    public function testDirReadable()
    {
        ...
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $result, 'Array of valid dirs');

        $check = new DirReadable(__FILE__);
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result, 'An existing file');

        $check = new DirReadable(__DIR__ . '/improbabledir99999999999999999999999999999999999999');
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result, 'Single non-existent dir');
    ...
    public function testDirWritable()
    {
        ...
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result, 'Non-existent path');
        ...
        $check = new DirWritable($path);
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $result, 'Non-dir path');
        $this->assertStringMatchesFormat($path . '%s', $result->getMessage());
        ...
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $result, 'Single writable dir');
        ...
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $result, 'Multiple writable dirs');
    ...
    public function testSecurityAdvisory()
    {
        ...
        $result = $check->check();
        $this->assertNotInstanceOf('Laminas\Diagnostics\Result\Failure', $result);
    ...
    public function testSecurityAdvisoryInvalidServerResponse()
    {
        ...
        $check->setSecurityChecker($checker);
        $result = $check->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Warning', $result);
    }
    /**
     * @depends testSecurityAdvisory
     */
    ...
    public function testAbstractFileCheckArgument1()
    {
        ...
        $this->assertInstanceOf('Laminas\Diagnostics\Result\SuccessInterface', $check->check());
    ...
    public function testXmlFileInvalid()
    {
        ...
        $check = new XmlFile($path);
        $this->assertInstanceOf('Laminas\Diagnostics\Result\FailureInterface', $check->check());
