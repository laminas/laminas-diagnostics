...
class DirWritableTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @var string
     */
    private $checkClass = 'Laminas\Diagnostics\Check\DirWritable';
    ...
    public function testCheckSuccessSinglePath()
    {
        ...
        $r = $object->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Success', $r);
    ...
    public function testCheckFailureSingleInvalidDir()
    {
        ...
        $r = $object->check();
        $this->assertInstanceOf('Laminas\Diagnostics\Result\Failure', $r);
